...
<%
        ...
        try {
			int rowsaffected = st.executeUpdate("update student set fullname='"+fullname+"',btechcgpa='"+btechcgpa+"',intermarks='"+intermarks+"',tenthcgpa='"+tenthcgpa+"',activebacklogs='"+activebacklogs+"',branch='"+branch+"',contactno='"+contactno+"',personalemail='"+personalemail+"',companiesplaced='"+companiesplaced+"',password='"+password+"',companiesregistered='"+companiesregistered+"' where jntuno='"+jntuno+"' ");
