...
<%@ page import="java.io.*,java.sql.*, java.util.*, java.text.*,  java.util.Date" %>
<!DOCTYPE html>
<html>
	<head>
...
<%
	try {
		...
		int rowsaffected = st.executeUpdate("insert into company(companyname, drive, onoffcampus, reglink, lastdate) values('"+companyname+"', '"+drive+"', '"+onoffcampus+"', '"+reglink+"', '"+lastdate+"')");
		if(rowsaffected == 1) {
...
%>
			...
			<div class="alert alert-warning" role="alert">
					Not Registered Successfully......... Please Try Again <a href="adminaddcompany.jsp">Here</a>
			</div>
...
%>
		...
		<div class="alert alert-warning" role="alert">
				Some Error Occured...Not Registered Successfully......... Please Try Again <a href="adminaddcompany.jsp">Here</a>
		</div>
