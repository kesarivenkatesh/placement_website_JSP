		...
		<div class="container mt-5" style="max-width: 678px;">
		        <div class="row">
		            <div class="card border mb-3">
		                <div class="card-body">
		                	<div class="card-title" align="center"><h4>Delete Company Details</h4></div>
		                    <form action="deletecompanyfromdb.jsp" method="POST" ng-app="" name="registerform">
		                        <div class="mb-3">
		                        ...
		                        <div class="d-grid">
                            		<button type="submit" class="btn btn-primary btn-block" name="register" ng-disabled="companyname==null || companyname=='' || drive==null || drive=='' ">Delete</button>
                        		</div>
		                    </form>
		                </div>
		            </div>
